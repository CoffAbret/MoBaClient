...
namespace HedgehogTeam.EasyTouch
{
    ...
    public class EasyTouch : MonoBehaviour
    {
        ...
        public enum EvtType
        {
            None, On_TouchStart, On_TouchDown, On_TouchUp, On_SimpleTap, On_DoubleTap, On_LongTapStart, On_LongTap,
...
#if ((!UNITY_ANDROID && !UNITY_IOS && !UNITY_TVOS && !UNITY_WINRT && !UNITY_BLACKBERRY) || UNITY_EDITOR||UNITY_STANDALONE_WIN)
