...
//		_NormalTex ("Normal", 2D) = "bump" {}
	...
	SubShader 
	{
		...
		LOD 200
 		Pass 
 		{
	  		Tags { "RenderType"="Opaque" "HeroShader"="1" "LightMode" = "ForwardBase" }
	  		Fog { Mode Off }		
...
//		 	sampler2D _NormalTex;
		    ...
		    fixed4 frag(voutput i) : COLOR
		    {
				...
				float4 mainColor = tex2D (_MainTex, i.texcoord0);
				float4 maskColor = tex2D (_MaskTex, i.texcoord0);
				...
				finalColor.xyz = (ramp + _AmbientColor * shadow) * albedo;
