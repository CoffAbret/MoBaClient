...
[Serializable]
public class SkillTreeViewItem
{
    ...
    public List<SkillTreeViewItem> Items = new List<SkillTreeViewItem>();

    public TreeViewControl ParentControl = null;
    public SkillTreeViewItem Parent = null;
    ...
    public SkillTreeViewItem(TreeViewControl parentControl, SkillTreeViewItem parent)
    {
    ...
    public SkillTreeViewItem AddItem(string header)
    {
        SkillTreeViewItem item = new SkillTreeViewItem(ParentControl, this) { Header = header };
        Items.Add(item);
        return item;
    }

    public SkillTreeViewItem AddItem(string header, bool isExpanded)
    {
        SkillTreeViewItem item = new SkillTreeViewItem(ParentControl, this) { Header = header, IsExpanded = isExpanded };
        Items.Add(item);
        return item;
    }

    public SkillTreeViewItem AddItem(string header, bool isExpanded, bool isChecked)
    {
        SkillTreeViewItem item = new SkillTreeViewItem(ParentControl, this) { Header = header, IsExpanded = isExpanded, IsCheckBox = true, IsChecked = isChecked };
        Items.Add(item);
        return item;
    }
    ...
    public void DisplayItem(int levels, SiblingOrder siblingOrder)
    {
            ...
            IsExpanded)
        {
            ...
            {
                SkillTreeViewItem child = Items[index];
                child.Parent = this;
