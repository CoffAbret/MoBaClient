...
public class TreeViewControl
{
    ...
    /// The root item
    /// </summary>
    public SkillTreeViewItem m_roomItem = null;
    public SkillTreeViewItem RootItem
    {
        get
        {
            if (null == m_roomItem)
            {
                m_roomItem = new SkillTreeViewItem(this, null) { Header = "Root item" };
            }
            return m_roomItem;
        }
    }
    ...
    /// </summary>
    public List<SkillTreeViewItem> Items
    {
        get
        {
    ...
    /// The selected item
    /// </summary>
    public SkillTreeViewItem HoverItem = null;
	public SkillTreeViewItem SelectedItem = null;
    ...
    /// <returns></returns>
    public bool Button(SkillTreeViewItem.TextureIcons item)
    {
        switch (item)
        {
            case SkillTreeViewItem.TextureIcons.BLANK:
				...
				return false;
            case SkillTreeViewItem.TextureIcons.GUIDE:
                if (null == m_textureGuide ||
                    m_forceButtonText)
                {
				...
				return false;
            case SkillTreeViewItem.TextureIcons.LAST_SIBLING_COLLAPSED:
            ...
            case SkillTreeViewItem.TextureIcons.LAST_SIBLING_EXPANDED:
            ...
            case SkillTreeViewItem.TextureIcons.LAST_SIBLING_NO_CHILD:
            ...
            case SkillTreeViewItem.TextureIcons.MIDDLE_SIBLING_COLLAPSED:
            ...
            case SkillTreeViewItem.TextureIcons.MIDDLE_SIBLING_EXPANDED:
            ...
            case SkillTreeViewItem.TextureIcons.MIDDLE_SIBLING_NO_CHILD:
			...
			case SkillTreeViewItem.TextureIcons.NORMAL_CHECKED:
			...
			case SkillTreeViewItem.TextureIcons.NORMAL_UNCHECKED:
    ...
    public void DisplayTreeView(TreeViewControl.DisplayTypes displayType)
    {
        ...
        RootItem.DisplayItem(0, SkillTreeViewItem.SiblingOrder.FIRST_CHILD);
